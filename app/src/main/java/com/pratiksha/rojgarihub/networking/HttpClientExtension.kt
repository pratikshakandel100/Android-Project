...
fun constructRoute(route: String): String {
    return when {
        route.contains(ApiEndpoints.ROJGARI_HUB_API_BASE_URL) -> route
        route.startsWith("/") -> ApiEndpoints.ROJGARI_HUB_API_BASE_URL + route
        else -> ApiEndpoints.ROJGARI_HUB_API_BASE_URL + "/$route"
    }
}